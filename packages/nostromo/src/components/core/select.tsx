...
const selectTriggerVariants = cva(
  "flex h-10 w-full items-center justify-between rounded-md border bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 transition-all duration-200 shadow-sm hover:shadow-md",
  {
    variants: {
      variant: {
        ...
        error:
          "border-destructive hover:border-destructive/80 focus:border-destructive focus:ring-destructive",
        success:
  ...
  "relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50 transition-all duration-200",
  {
    variants: {
      variant: {
        ...
        error:
          "focus:bg-destructive/10 focus:text-destructive hover:bg-destructive/5",
        success:
          "focus:bg-success-100 focus:text-success-900 hover:bg-success-50",
      },
    },
    defaultVariants: {
      variant: "default",
