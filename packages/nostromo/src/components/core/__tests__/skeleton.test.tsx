...
describe("Skeleton", () => {
  it("renders skeleton with default props", () => {
    ...
    // bg-neutral-200, not bg-muted: muted is 96% against a 98% background in light
    // mode - two points apart and effectively invisible.
  ...
  it("renders with custom variant", () => {
    const { rerender } = render(
      <Skeleton variant="primary" className="w-64 h-4" />,
    );
    expect(screen.getByLabelText("Loading content")).toHaveClass(
      "bg-primary/10",
    );
...
describe("SkeletonText", () => {
  ...
  it("renders with custom spacing", () => {
    ...
    expect(screen.getByLabelText("Loading text content")).toHaveClass(
      "space-y-1",
    );
  ...
  it("does not render when loading is false", () => {
    ...
    expect(
      screen.queryByLabelText("Loading text content"),
...
describe("SkeletonAvatar", () => {
  ...
  it("renders with custom variant", () => {
    ...
    expect(screen.getByLabelText("Loading avatar")).toHaveClass(
      "bg-primary/10",
    );
  });
...
describe("SkeletonCard", () => {
  ...
  it("does not render when loading is false", () => {
    ...
    expect(
      screen.queryByLabelText("Loading card content"),
    ).not.toBeInTheDocument();
  });
});
...
describe("SkeletonTable", () => {
  ...
  it("does not render when loading is false", () => {
    ...
    expect(
      screen.queryByLabelText("Loading table content"),
    ).not.toBeInTheDocument();
  });
});
...
describe("SkeletonList", () => {
  ...
  it("does not render when loading is false", () => {
    ...
    expect(
      screen.queryByLabelText("Loading list content"),
    ).not.toBeInTheDocument();
  });
});
