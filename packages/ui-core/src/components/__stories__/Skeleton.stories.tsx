        ...
        <div className="grid grid-cols-2 gap-4 max-w-md">
          <div>
            ...
            <select
              ...
              onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setSelectedVariant(e.target.value as 'default' | 'light' | 'dark' | 'primary' | 'success' | 'warning' | 'error')}
          ...
          <div>
            ...
            <select
              value={selectedSize}
              onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setSelectedSize(e.target.value as 'xs' | 'sm' | 'md' | 'lg' | 'xl' | '2xl' | '3xl')}
              className="w-full border border-gray-300 rounded px-3 py-2"
            >
          ...
          <div>
            ...
            <select
              value={selectedShape}
              onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setSelectedShape(e.target.value as 'rectangle' | 'circle' | 'square' | 'pill')}
              className="w-full border border-gray-300 rounded px-3 py-2"
            >
          ...
          <div>
            ...
            <select
              ...
              onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setSelectedAnimation(e.target.value as 'pulse' | 'wave' | 'none')}
              className="w-full border border-gray-300 rounded px-3 py-2"
            >
          ...
          <div className="col-span-2">
            <label className="flex items-center space-x-2">
              <input
                type="checkbox"
                checked={loading}
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => setLoading(e.target.checked)}
              />
