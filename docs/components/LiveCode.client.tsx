      ...
      >
        <div className="border border-border rounded-2xl overflow-hidden shadow-2xl bg-card transition-all duration-300 hover:border-accent/30">
          ...
          <div className="p-8 bg-background relative min-h-[160px] flex items-center justify-center">
            {isLoading && (
              <div className="absolute inset-0 flex items-center justify-center bg-background z-20">
                <div className="flex flex-col items-center gap-4">
                  ...
                  <span className="text-[10px] uppercase font-bold tracking-[0.2em] opacity-50">
                    Transmitting Data...
                  </span>
                </div>
              </div>
            ...
            <LiveError className="absolute bottom-4 left-4 right-4 p-4 bg-red-950/90 backdrop-blur border border-red-500/50 rounded-lg text-red-200 text-xs font-mono shadow-2xl z-30" />
          </div>
