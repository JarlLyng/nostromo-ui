...
```tsx
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogDescription, DialogTrigger } from '@jarllyng/nostromo'
// or
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogDescription, DialogTrigger } from '@jarllyng/nostromo/dialog'
```

## Usage

```tsx
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogTrigger } from '@jarllyng/nostromo'
...
<LiveCode code={`import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogTrigger, Button } from '@jarllyng/nostromo'
...
<LiveCode code={`import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogTrigger, Button, Input, Label } from '@jarllyng/nostromo'
