...
<LiveCode code={`import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from '@jarllyng/nostromo'
  ...
  return (
    <Accordion type="single" collapsible>
      ...
      <AccordionItem value="item-2">
        ...
        <AccordionContent>
          You can install it with npm: <code>npm install @jarllyng/nostromo</code>
        </AccordionContent>
      </AccordionItem>
    </Accordion>
  )
