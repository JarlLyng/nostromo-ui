...
export default function Example() {
  return <Input type="email" placeholder="Enter your email" label="Email" />;
}
```

## Live Examples

<LiveCode code={`import { Input } from '@jarllyng/nostromo'
...
```jsx
import { Input, Label } from "@jarllyng/nostromo";
