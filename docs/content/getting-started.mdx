...
These are the published package's own requirements, taken from its `engines`
and `peerDependencies`. Building the library itself asks for more, and
[CONTRIBUTING.md](https://github.com/JarlLyng/nostromo-ui/blob/main/CONTRIBUTING.md)
says what.
