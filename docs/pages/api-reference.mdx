...
> **Tip**: Import components from `@jarllyng/ui-core` or `@jarllyng/ui-marketing` to get full TypeScript support and autocomplete.
...
```tsx
import type { ButtonProps, InputProps } from '@jarllyng/ui-core'
```
...
import { Button, Input, Label } from '@jarllyng/ui-core'
...
import { Dialog, DialogContent, DialogTrigger } from '@jarllyng/ui-core'
