...
<div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
  <div className="nx-card">
    ...
    <div className="flex gap-2">
      <div className="flex-1 p-4 rounded-lg bg-background border border-border">
        ...
        <div className="h-16 rounded bg-gradient-to-br from-primary/20 to-primary/5"></div>
      </div>
      <div className="flex-1 p-4 rounded-lg bg-neutral-900 border border-border">
        <div className="text-xs font-medium mb-2 text-neutral-200">Dark</div>
        <div className="h-16 rounded bg-gradient-to-br from-primary/30 to-primary/10"></div>
      </div>
    </div>
  </div>
  ...
  <div className="nx-card">
    ...
    <div className="flex gap-2">
      <div className="flex-1 p-4 rounded-lg bg-background border border-border">
        <div className="text-xs font-medium mb-2">Light</div>
        <div className="h-16 rounded bg-gradient-to-br from-cyan-200/20 to-cyan-100/5"></div>
      </div>
      <div className="flex-1 p-4 rounded-lg bg-neutral-900 border border-border">
        <div className="text-xs font-medium mb-2 text-neutral-200">Dark</div>
        <div className="h-16 rounded bg-gradient-to-br from-cyan-400/30 to-cyan-300/10"></div>
      </div>
    </div>
  </div>
  ...
  <div className="nx-card">
    ...
    <div className="flex gap-2">
      <div className="flex-1 p-4 rounded-lg bg-background border border-border">
        <div className="text-xs font-medium mb-2">Light</div>
        <div className="h-16 rounded bg-gradient-to-br from-orange-200/20 to-orange-100/5"></div>
      </div>
      <div className="flex-1 p-4 rounded-lg bg-neutral-900 border border-border">
        <div className="text-xs font-medium mb-2 text-neutral-200">Dark</div>
        <div className="h-16 rounded bg-gradient-to-br from-orange-400/30 to-orange-300/10"></div>
      </div>
    </div>
  </div>
  ...
  <div className="nx-card">
    ...
    <div className="flex gap-2">
      <div className="flex-1 p-4 rounded-lg bg-background border border-border">
        <div className="text-xs font-medium mb-2">Light</div>
        <div className="h-16 rounded bg-gradient-to-br from-blue-200/20 to-blue-100/5"></div>
      </div>
      <div className="flex-1 p-4 rounded-lg bg-neutral-900 border border-border">
        <div className="text-xs font-medium mb-2 text-neutral-200">Dark</div>
        <div className="h-16 rounded bg-gradient-to-br from-blue-400/30 to-blue-300/10"></div>
      </div>
    </div>
  </div>
</div>
