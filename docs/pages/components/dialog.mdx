...
```tsx
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogDescription, DialogTrigger } from '@jarllyng/ui-core'
// or
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogDescription, DialogTrigger } from '@jarllyng/ui-core/dialog'
```

## Usage

```tsx
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogTrigger } from '@jarllyng/ui-core'
...
<LiveCode code={`import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogTrigger, Button } from '@jarllyng/ui-core'
...
<LiveCode code={`import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogTrigger, Button, Input, Label } from '@jarllyng/ui-core'
