...
**Live Examples:**
- [Dialog Examples](https://stackblitz.com/edit/nostromo-ui-dialog) - Interactive dialog playground
- [Dialog with Actions](https://stackblitz.com/edit/nostromo-ui-dialog-actions) - Dialog with buttons
- [Form Dialog](https://stackblitz.com/edit/nostromo-ui-dialog-form) - Dialog with form

**CodeSandbox:**
- [Dialog Playground](https://codesandbox.io/s/nostromo-ui-dialog) - Fork and experiment
