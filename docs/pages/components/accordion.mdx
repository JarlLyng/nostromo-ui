...
<LiveCode code={`import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from '@jarllyng/ui-core'
  ...
  return (
    <Accordion type="single" collapsible>
      ...
      <AccordionItem value="item-2">
        ...
        <AccordionContent>
          You can install it with npm: <code>npm install @jarllyng/ui-core</code>
        </AccordionContent>
      </AccordionItem>
    </Accordion>
  )
