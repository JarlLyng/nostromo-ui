...
<LiveCode code={`import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@jarllyng/ui-core'
...
<LiveCode code={`import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue, Label } from '@jarllyng/ui-core'
