...
**Open in StackBlitz:**
- [Tabs Examples](https://stackblitz.com/edit/nostromo-ui-tabs?file=src/App.tsx) - Interactive tabs playground
- [Tabs with Icons](https://stackblitz.com/edit/nostromo-ui-tabs-icons?file=src/App.tsx) - Tabs with icon support
- [Pills Tabs](https://stackblitz.com/edit/nostromo-ui-tabs-pills?file=src/App.tsx) - Pills variant

**Open in CodeSandbox:**
- [Tabs Playground](https://codesandbox.io/s/nostromo-ui-tabs-xyz123) - Fork and experiment
