...
**Live Examples:**
- [Tabs Examples](https://stackblitz.com/edit/nostromo-ui-tabs) - Interactive tabs playground
- [Tabs with Icons](https://stackblitz.com/edit/nostromo-ui-tabs-icons) - Tabs with icon support
- [Pills Tabs](https://stackblitz.com/edit/nostromo-ui-tabs-pills) - Pills variant
