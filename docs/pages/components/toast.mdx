...
<StorybookEmbed story="components-toast--success" />

<StorybookEmbed story="components-toast--with-action" />

## Examples

### Using the Hook

<LiveCode code={`import { ToastProvider, useToast } from '@nostromo/ui-core'
