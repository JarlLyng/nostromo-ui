...
```tsx
import { Textarea, Label } from '@jarllyng/nostromo'
...
<LiveCode code={`import { Textarea } from '@jarllyng/nostromo'
...
<LiveCode code={`import { Textarea, Label } from '@jarllyng/nostromo'
