...
```tsx
import { Checkbox, Label } from '@jarllyng/ui-core'
...
<LiveCode code={`import { Checkbox } from '@jarllyng/ui-core'
...
<LiveCode code={`import { Checkbox, Label } from '@jarllyng/ui-core'
