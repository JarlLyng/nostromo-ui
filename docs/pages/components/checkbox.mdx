...
```tsx
import { Checkbox, Label } from '@jarllyng/nostromo'
...
<LiveCode code={`import { Checkbox } from '@jarllyng/nostromo'
...
<LiveCode code={`import { Checkbox, Label } from '@jarllyng/nostromo'
