...
> [!NOTE]
> Storybook is currently deprecated in favor of the [Live Examples](/getting-started#basic-usage) integrated directly into this documentation.

## 🚀 Live Storybook (Legacy)

**Access our legacy Storybook instance:**

- **[Live Storybook](https://jarllyng.github.io/nostromo-ui/storybook-static/)** - Archive component playground
- **Note**: This instance may not reflect the latest changes in the unified `@jarllyng/nostromo` package.

## Local Development

Local Storybook support is currently being refactored to align with our unified package structure. We recommend using the interactive examples built directly into the component documentation pages for development.
